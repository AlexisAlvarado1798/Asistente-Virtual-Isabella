  ...
  return l.SystemInfo = function () {
    ...
    a.prototype.send = function (t) {
      ...
      return o.enabled = o.enabled && "arraybuffer" == n.responseType && !t, o.enabled ? void u.execute(i.name, "get", [o.result.url], function (t) {
        ...
        if (o.result = t, o.result.accessed = Date.now(), "immutable" == o.control) o.revalidated = !0, u.execute(i.name, "put", [o.result]), n.dispatchEvent(new Event("load")), e("'" + o.result.url + "' served from the indexedDB cache without revalidation"); else if (r(o.result.url) && (o.result.responseHeaders["Last-Modified"] || o.result.responseHeaders.ETag)) {
